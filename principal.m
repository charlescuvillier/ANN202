...
erreur_H1= sqrt((UU_ex(1:Nbaretes_int)-UU_bar(1:Nbaretes_int))'*KK_int*(UU_ex(1:Nbaretes_int)-UU_bar(1:Nbaretes_int)))
%cardinal de V^nc_h1 :
Nbaretes_int
...
err_pot = (UU_ex(1:Nbaretes_int)-UU_bar(1:Nbaretes_int))'*KK_int*(UU_ex(1:Nbaretes_int)-UU_bar(1:Nbaretes_int));
